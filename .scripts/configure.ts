...
try {
	unlinkSync(`./apps/admin/src/environments/environment.ts`);
} catch {}
try {
	unlinkSync(`./apps/admin/src/environments/environment.prod.ts`);
} catch {}
...
writeFile(
	`./apps/admin/src/environments/${envFileDest}`,
	envFileContent,
	function (err) {
		if (err) {
			console.log(err);
...
writeFile(
	`./apps/admin/src/environments/${envFileDestOther}`,
	'',
	function (err) {
		if (err) {
			console.log(err);
